...
<head>
    ...
    <script type="text/javascript" src="${basePath}/js/content/businessList.js?a=12"></script>
</head>
<body style="background: #e1e9eb;">
<form action="${basePath}/businesses/search" id="mainForm" method="post">
    <input id="hiddenMethod" type="hidden" name="_method" value="DELETE" />
            ...
            <table class="tab1">
                ...
                <tr>
                    ...
                    <td style="text-align: right;" width="150">
                        <input class="tabSub" value="添加" onclick="location.href='${basePath}/businesses/addPage'"/>
