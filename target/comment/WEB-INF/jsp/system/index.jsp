...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
		...
		<script type="text/javascript" src="${bashPath}/js/system/index.js?a=3"></script>
	</head>
	<body>
		<!-- 蒙版DIV -->
		    ...
		    <div id="header">
		        <div class="iheader">
		            ...
		            <ul class="nav" id="mainMenuUl">
							<li onclick="showAdList();" class="on"><a><span>内容管理</span></a></li>
						    <li onclick="showSysList();" class="on"><a><span>系统管理</span></a></li>
		            </ul>
		        </div>
		    </div>
		    <div id="container">
		        <table style="vertical-align:top" cellspacing="0" cellpadding="0" bgcolor="#e1e9eb" border="0">
		            ...
		            <tr>
		                <td class="leftTd" style="vertical-align:top" width="150">
		                    <div class="left">
		                        <div class="ileft" id="menuAdDiv">
		                        	<h3 onclick="clickSecondMenu(this,'${bashPath}/ad')"><a>广告管理</a></h3>
									<h3 onclick="clickSecondMenu(this,'${basePath}/businesses')"><a>商户管理</a></h3>
		                        </div>
								<div class="ileft hiddeList" id="menuSysDiv">
									<h3 onclick="clickSecondMenu(this,'${bashPath}/permissons')"><a>权限管理</a></h3>
								</div>
		                    </div>
		                </td>
		                <td width="7">
